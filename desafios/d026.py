...
print(f'A primeira letra "A" aparece na posição {(frase.find("a")+1)}.') # "+1" pois para o Pyhon é posição "0", mas para pessoas faz mais sentido posição "1". Então 0 + 1.
print(f'A última letra "A" aparece na posição {(frase.rfind("a")+1)}.') # "rfind" é para iniciar a procura pelo lado direito, do final em direção ao começo.
